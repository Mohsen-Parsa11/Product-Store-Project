        ...
        <Container>
            <div className='flex flex-col md:flex-row items-center space-y-4 md:space-y-0 justify-center lg:justify-between'>
                ...
                <div className='flex justify-between border-2 border-gray-200 md:ml-10 lg:mr-10 hover:border-gray-800 items-center py-1 px-3 w-full rounded-md '>
                    <input type="text" placeholder='Enter your product name...' className='border-0 outline-none w-full'/>
                ...
                <div className='hidden lg:flex items-center space-x-4'>
                    ...
                    <p className='hidden login bg-slate-600 text-white rounded px-2 py-1 absolute -top-9 -left-8'>login</p>
                    </Link>
                    <div className='relative'>
                        <FiHeart className='scale-125 text-gray-500'/>
                        <div className='absolute flex items-center justify-center -right-2 -top-1 bg-red-500 w-4 h-4 text-xs text-white rounded-full'>21</div>
                    </div>
                    <div className='relative'>
                        <Link href='/cart'><CgShoppingCart  className='scale-125 text-gray-500 cursor-pointer'/></Link>
                        <div className='absolute flex items-center justify-center -right-2 -top-2  bg-red-500 text-sm w-3 h-3 text-white p-2 rounded-full'>{totalProductQty}</div>
                    </div>
                </div>
            </div>
        </Container>
